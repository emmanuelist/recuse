...
| ISSUE-027 | **Fixed.** Corroboration accepted a 60% term overlap and reported CORROBORATED for "Northwind Trading Ltd, registered in Delaware" while citing UK Companies House — it matched the name and ignored the jurisdiction. Every distinctive term must now appear, and the verdict names which term went unsupported. Verified to discriminate: the Delaware claim about a UK company is now UNVERIFIED, while "Stripe Inc registered in Delaware" still corroborates. |
